...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT  :  the variable "rando" was defined locally within the displayPics function, if you log it to the console outside of the function it will be undefined because its locally scoped.
  console.log(viewed);
